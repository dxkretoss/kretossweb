            ...
            <section className="pt-20 pb-20 contact">
                <div className='contact-content-wrapper'>
                    ...
                    <div className="contact-about-block">
                        ...
                        <div className="flex flex-col justify-start items-start gap-5 mt-12 pt-10 border-t border-gray-100">
                            ...
                            <div className="flex flex-col items-start gap-4">
                                ...
                                <div className="flex flex-col gap-1">
                                    <h3 className="text-[22px] font-bold text-[#111] tracking-tight">Ankur Patel</h3>
                                    <div className="text-[15px] font-medium text-gray-500">CEO & Founder</div>
                                </div>
                            </div>
                        </div>
