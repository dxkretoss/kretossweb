    ...
    const cards = [
        {
            ...
            bgText: "REACT FRONTEND UI UX COMPONENT STATE MANAGEMENT HOOKS VIRTUAL DOM PERFORMANCE FAST SCALABLE REACT FRONTEND UI UX ",
            desc: "Hire expert React developers to build dynamic, high-performance user interfaces that scale with your business needs."
        },
        {
            title: "NODE.JS",
            icon: (
            ...
            bgText: "NODEJS BACKEND API SERVER ASYNCHRONOUS EVENT DRIVEN FAST SCALABLE DATABASE MICROSERVICES NODEJS BACKEND API SERVER ",
            desc: "Empower your applications with robust, event-driven Node.js backend architectures designed for speed and reliability."
        },
        {
            title: "NEXT.JS",
            icon: (
            ...
            bgText: "NEXTJS SSR SSG SEO PERFORMANCE FULLSTACK API ROUTES SERVER COMPONENTS REACT ECOSYSTEM NEXTJS SSR SSG SEO ",
            desc: "Deliver incredibly fast, SEO-optimized applications using the power of Next.js server-side rendering and static generation."
        }
    ];
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-7xl relative z-10 mt-8 lg:mt-0">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
                    ...
                    <div className="w-full lg:w-[55%] flex flex-col items-center sm:items-start text-center sm:text-left relative z-20">
                        ...
                        <div className='mb-5'>
                            <Badge variant='white'>Hire Dedicated Developers</Badge>
                        </div>
                        ...
                        <h1 className="banner-title text-[32px] lg:text-[60px] font-bold text-white leading-[1.1] sm:leading-[1.1] tracking-tight mb-6 lg:mb-8">
                            <AnimatedWord text="Build Your " isGradient={false} /><br />
                            <AnimatedWord text="Dream " isGradient={false} />
                            <AnimatedWord text="Team " isGradient={true} /><br />
                            <AnimatedWord text="With Top " isGradient={false} />
                            <AnimatedWord text="Talent" isGradient={true} />
                        </h1>

                        <p className="banner-text text-base sm:text-xl text-gray-300 max-w-lg font-medium mb-8 ">
                            <AnimatedWord text="Hire world-class dedicated developers for your project. Flexible engagement models, top 1% tech talent, and zero hiring hassle." isGradient={false} />
                        </p>
                    ...
                    <div className="w-full lg:w-[45%] relative z-20 flex justify-center ">
                        <div className="hero-video-box relative w-full max-w-[320px] sm:max-w-[380px]">
                            ...
                            <div className="relative w-full aspect-[4/3] sm:aspect-[4/3] perspective-[1000px]">
                                {cards.map((card, idx) => {
