...
export default function TeamSection() {
    ...
    return (
        <section className="w-full bg-[#fafcff] text-black py-10 lg:py-20 relative overflow-hidden " ref={sectionRef}>
            <div className='w-layout-blockcontainer container-full-width'>
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center relative z-10">
                    ...
                    <div className="team-left-content flex flex-col items-center sm:items-start text-center sm:text-left">
                        ...
                        {/* Description */}
                        <p className="text-justify lg:text-left text-gray-500 text-sm sm:text-lg leading-relaxed mb-0 sm:mb-10 max-w-xl">
