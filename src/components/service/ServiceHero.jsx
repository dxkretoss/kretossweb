                    ...
                    <div className="w-full lg:w-[55%] flex flex-col items-start relative z-20">
                        <div className="about-subtitle-box mb-4" style={{ backgroundColor: 'transparent' }}>
                            <img
                                ...
                                loading="lazy" alt="Services Subtitle Icon" className="subtitle-image-icon animate-[spin_4s_linear_infinite]"
                            />
                            <span className="text-xs text-gray-300 font-medium tracking-widest uppercase mt-0.5">Our Services</span>
                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="relative w-full h-[35%] bg-[#080808] overflow-hidden flex items-center justify-center border-b border-white/5">
                                                ...
                                                <div className="relative z-10 flex flex-col items-center">
                                                    <h3 className={`text-3xl sm:text-4xl font-black tracking-tighter bg-gradient-to-r ${card.gradient} text-transparent bg-clip-text drop-shadow-[0_0_20px_rgba(255,255,255,0.1)]`}>
                                                        {card.title}
                                                    </h3>
                                                </div>
                                            </div>
